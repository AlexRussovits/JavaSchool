...
<form action="updateCustomerRoles" method="POST">
    ...
    <div class="form-group w-50 mx-auto">    
        ...
        <input value="${editCustomer.login}" type="text" class="form-control" id="newLogin" name="newLogin" aria-describedby="newLoginHelp" placeholder="Логин">
    ...
    <div class="form-group w-50 mx-auto">    
        ...
        <input value="${topRoleEditCustomer}" type="text" class="form-control" id="currentRole" name="currentRole" aria-describedby="currentRoleHelp" placeholder="Текущая роль">
