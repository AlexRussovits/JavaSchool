    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            case "/index":
                ...
                break;
            case "/showFormLogin":
                request.getRequestDispatcher("/systemPages/showFormLogin.jsp").forward(request, response);
                break;
            case "/login":
                ...
                String topRoleCurrentUser = userRolesFacade.getTopRoleName(user);
            ...
            case "/showFormAddUser":
                request.getRequestDispatcher("/pages/showFormAddUser.jsp").forward(request, response);
                break;
            case "/createUser":
